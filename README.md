...
<br/>
<div>For both options to create or edit, user can pick their availability in PST (Pacific Time) for the team to know (time slot boxes with darker color have more team members available at that time for a meeting)</div>
